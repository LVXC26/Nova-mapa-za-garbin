...
import { ArrowLeft, MapPin, Star, CheckCircle, Mail, Calendar, Award, Globe, Ship, Users, Building2, Trash2, Pencil } from 'lucide-react'
...
export default function SkipperVsebina({ params }: { params: Promise<{ id: string }> }) {
  const { id } = use(params)
  const { user } = useAuth()
  ...
  useEffect(() => {
    ...
    // skiperji_javno — brez cena_dan; admin jo vidi prek posebne poizvedbe
    // na osnovno tabelo spodaj (RLS jo dovoli le adminu).
